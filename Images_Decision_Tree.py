...
plt.title("Validation Curve with Decision Tree Classifier on the Images Data")
...
plt.figure()
plt.title("Learning curve with Decision Tree on the Images Data")
plt.xlabel("Training examples")
plt.ylabel("Score")

train_sizes = np.linspace(.1, 1.0, 20)
train_sizes, train_scores, test_scores = learning_curve(tree.DecisionTreeClassifier(class_weight='balanced', max_depth=10), data_train, label_train, cv=5, n_jobs=4, train_sizes=train_sizes)
